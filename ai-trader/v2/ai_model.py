...
# ★ 纯动态配置：启动时强制从 ai_config.json 加载
API_URL = None
API_KEY = None
MODEL = None
DEBUG_LOG = Path(__file__).resolve().parent.parent / "mimo_debug.log"
CONFIG_PATH = Path(__file__).resolve().parent.parent / "ai_config.json"
